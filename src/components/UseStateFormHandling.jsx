        ...
        <div className='UseStateFormHandling container-fluid bg-body-tertiary  min-vh-100 text-uppercase'>
            ...
            <form action="" className="form-container container-sm shadow rounded-3 p-3 mt-5 ">
                <div className="form-group container-md mt-3">
                    ...
                    <input onChange={(e)=>setName(e.target.value)} type="text" className='form-control form-control-lg  ' id='user-name1' placeholder='Enter Your Name' />
                </div>
                <div className="form-group container-md mt-3 ">
                    <label htmlFor="user-password1" className='fs-5 ms-2 py-2 fw-lighter fst-italic mb-1 ' > Password</label>
                    <input onChange={(e)=>changePassword(e)} type="password" className='form-control form-control-lg' id='user-password1' placeholder='Enter Your Password' />
                </div>
                <div className="form-group container-md mt-3">
                    <p className='text-muted fs-7 fw-lighter  fst-italic ms-2 my-0 py-0' >Comment here </p>
                    <textarea onChange={(e)=>setMessage(e.target.value)} name="" id="textarea" placeholder='this is text area ' className='form-control form-control-lg mb-4'></textarea>
                </div>
                <div className="form-grop select-container ">
                    <select className="userOption " onChange={(e)=>setLangue(e.target.value)}>
                ...
                <div className="form-group">
                    <input onChange={(e)=>setCheckBox(e.target.value)} value={!checkBox} type="checkbox" id="checkBopx1" className="checkbox" /> <p className='checkBox-p'>I accept term and condition!</p>
                </div>
